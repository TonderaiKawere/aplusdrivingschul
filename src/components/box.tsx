    ...
    >
        ...
        >
          <CardMedia
            ...
            style={{
              ...
              objectFit: "cover", // Ensure the image covers the container area without distortion
              objectPosition: "top", // Align the image to the top so that the top half is visible\
            }}
          />
          <IconButton
            aria-label="facebook"
      ...
      <Grid item xs={12} sm={6} md={3}>
        ...
        >
          ...
          <CardContent>
            <Typography variant="body2" component="p" textAlign="left" mb={3}>
              I was nervous about driving, but A Plus Driving School instructors
              were amazing. They helped me overcome my fears and become a
              confident driver. Their comprehensive curriculum and supportive
              approach made all the difference. Highly recommend!
            </Typography>
            <Grid container justifyContent="space-between" alignItems="center">
              <Grid item>
                <Typography variant="body2" component="p">
        ...
        >
          ...
          <CardContent>
            <Typography variant="body2" component="p" textAlign="left" mb={3}>
              ...
              were professional, patient, loving and dedicated to my success.
              They provided me with the skills I needed to become a safe driver,
